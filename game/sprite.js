...
function initSprites(img) {
	...
	s_bird = [
		new Sprite(img, 0, 203, 90, 95),
		new Sprite(img, 90, 203, 90, 95),
		new Sprite(img, 180, 203, 90, 95)
	];
	
	s_bg = new Sprite(img,   0, 0, 138, 114);
	s_bg.color = "#87bbf3"; // save background color
	s_fg = new Sprite(img, 138, 0, 112,  20);
	
	s_pipeNorth = new Sprite(img, 150, 306, 150, 75);
	s_pipeSouth = new Sprite(img, 0, 306, 150, 75);
	...
	s_diamond = new Sprite(img, 213, 178, 39, 30);
